...
if ( ! function_exists( 'hello_elementor_scripts_styles' ) ) {
	...
	function hello_elementor_scripts_styles() {
		...
		// Enqueue UrbanBeat Custom Design System & Scripts (Inglu Internship Portfolio Upgrade)
		wp_enqueue_style(
			'urbanbeat-custom-style',
			HELLO_THEME_STYLE_URL . 'urbanbeat-custom.css',
			[],
			HELLO_ELEMENTOR_VERSION
		);

		wp_enqueue_script(
			'urbanbeat-custom-script',
			HELLO_THEME_SCRIPTS_URL . 'urbanbeat-main.js',
			[],
			HELLO_ELEMENTOR_VERSION,
			true
		);
